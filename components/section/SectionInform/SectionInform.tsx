    ...
    <section className="position-relative">
      ...
      <div className="position-absolute t-237 d-flex w-100 justify-content-center">
        <div className="max-w-999 text-center">
          <p className="text-24 text-light">LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISCING ELIT.</p>
          <h1 className="text-72 fw-bold line-89 text-center text-light mb-0">
